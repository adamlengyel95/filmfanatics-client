...
export const fetchMovies = () => dispatch => {
    axios.get('http://filmfanatics-api.rabit.hu/movies')
        .then((res) => {
...
export const fetchDirectors = () => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/artists/directors`)
        .then((res) => {
...
export const fetchActors = () => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/artists/actors`)
        .then((res) => {
...
export const fetchActorsByName = (actorName) => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/artists/actor`, {
        params:
            { name: actorName }
    }).then((res) => {
        const actors = res.data.map((actor) => {
...
export const fetchDirectorsByName = (directorName) => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/artists/director`, {
        params:
            { name: directorName }
    }).then((res) => {
        const directors = res.data.map((director) => {
...
export const fetchMoviesByTitle = (title) => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/movies/search`, {
        params:
            { title: title }
    }).then((res) => {
        const movies = res.data.map((movie) => {
...
export const fetchMoviesByGenre = (genreId) => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/movies/genre`, {
        params:
            { id: genreId }
    }).then((res) => {
        const movies = res.data.map((movie) => {
...
export const fetchMoviesByDecade = (decade) => dispatch => {
    axios.get(`http://filmfanatics-api.rabit.hu/movies/release`, {
        params:
